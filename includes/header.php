					...
					<div class="wrap-icon-header flex-w flex-r-m">
						<?php if (!isset($_SESSION['type'])) { ?>
							<li class="cl2 hov-cl1 trans-04 p-l-22 p-r-11">
								<a href="sign_in.php" class="cl1">Đăng nhập</a>
							</li>
							<li class="cl2 hov-cl1 trans-04 p-l-22 p-r-11">
								<a href="sign_up.php" class="cl1">Đăng kí</a>
							</li>
						<?php } elseif ($_SESSION['type'] == 0) { ?>
							<li class="cl2 hov-cl1 trans-04 p-l-22 p-r-11">
								<a href="profile.php" class="cl1">Hồ Sơ</a>
							</li>
							<li class="cl2 hov-cl1 trans-04 p-l-22 p-r-11">
								<a href="logout.php" class="cl1">Đăng Xuất</a>
							</li>
						<?php } elseif ($_SESSION['type'] == 1 || $_SESSION['type'] == 2) { ?>
							<li class="cl2 hov-cl1 trans-04 p-l-22 p-r-11">
								<a href="admin/index.php" class="cl1">Admin</a>
							</li>
							<li class="cl2 hov-cl1 trans-04 p-l-22 p-r-11">
								<a href="logout.php" class="cl1">Đăng nhập</a>
							</li>
						<?php } ?>
