...
if (isset($_GET["id"])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST["submit"])) {
            ...
            if ($comment == "") {
                ...
                $commentErorr = "Bạn cần viết một bình luận";
            }
    ...
    if (isset($_POST["add_to_cart"])) {
        $ok = 1;
        if ($_POST['size'] == 0) {
            $sizeError = "Bạn phải chọn kích thước!";
            $ok = 0;
        }
        if ($ok == 1) {
                    ...
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        <form method="POST">
                            ...
                            <span class="mtext-106 cl2">
                                <?php echo number_format($row["product_price"] * 23000, 0, ',', '.') . ' VND';  // Chuyển đổi từ USD sang VND ?>
                            </span>
                                    ...
                                    <div class="size-204 respon6-next">
                                        <div class="rs1-select2 bor8 bg0">
                                            <select class="js-select2" name="size">
                                                <option value="<?php echo $row['product_size'] == "" ? "-" : 0; ?>">Chọn một tùy chọn</option>
                                                <?php
                                                if ($row['product_size'] != "") {
			...
			<div class="bor10 m-t-50 p-t-43 p-b-40">
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item p-b-10">
							<a class="nav-link" data-toggle="tab" href="#reviews" role="tab">Đánh giá (<?php print_r(count($comments)); ?>)</a>
						</li>
					</ul>
