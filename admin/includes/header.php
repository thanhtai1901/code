      ...
      <div class="sidebar-start">
        ...
        <div class="sidebar-body">
          <ul class="sidebar-body-menu">
            <li>
              <a class="active" href="./index.php"><span class="icon home" aria-hidden="true"></span>Admin</a>
            </li>
            <?php
            if (isset($_SESSION["type"])) {
              if ($_SESSION["type"] == 2) {
                echo '<li>
                                  <a href="manage_admins.php"><span class="icon document" aria-hidden="true"></span>Tài khoản Quản lí</a>
                                </li>
                                <li>
                                  <a href="manage_users.php"><span class="icon document" aria-hidden="true"></span>Tài khoản người dùng</a>
                                </li>';
              }
            }
            ?>
            ...
            <li>
            <li>
              <a href="manage_categories.php"><span class="icon folder" aria-hidden="true"></span>Danh mục</a>
            </li>
            </li>
            <li>
            <li>
            ...
            <li>
              <a href="../index.php"><span class="icon paper" aria-hidden="true"></span>Quay lại Website</a>
            </li>
            </li>
          </ul>
          <?php
