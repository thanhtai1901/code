...
<?php
$sql = "SELECT * FROM orders WHERE order_status='on delivery'";
$result = mysqli_query($conn, $sql);
      ...
      <div class="col-md-6 col-xl-3">
        <article class="stat-cards-item">
          ...
          <div class="stat-cards-info">
            ...
            <p class="stat-cards-info__title">Tổng số người dùng đã đăng ký</p>
          </div>
        </article>
      </div>
      <div class="col-md-6 col-xl-3">
        <article class="stat-cards-item">
          ...
          <div class="stat-cards-info">
            ...
            <p class="stat-cards-info__title">Số lượng khách truy cập</p>
          </div>
        </article>
      </div>
      <div class="col-md-6 col-xl-3">
      ...
      <div class="col-md-6 col-xl-3">
        <article class="stat-cards-item">
          ...
          <div class="stat-cards-info">
            ...
            <p class="stat-cards-info__title">Số lượng đơn hàng đã hoàn thành</p>
          </div>
        </article>
      </div>
      <div class="col-md-6 col-xl-3">
        <article class="stat-cards-item">
          ...
          <div class="stat-cards-info">
            ...
            <p class="stat-cards-info__title">Số lượng đơn hàng đang giao</p>
          </div>
        </article>
      </div>
      <div class="col-md-6 col-xl-3">
        <article class="stat-cards-item">
          ...
          <div class="stat-cards-info">
            ...
            <p class="stat-cards-info__title">Số lượng đơn hàng đang chuẩn bị</p>
          </div>
        </article>
      </div>
      <div class="col-md-6 col-xl-3">
        <article class="stat-cards-item">
          ...
          <div class="stat-cards-info">
            ...
            <p class="stat-cards-info__title">Số lượng đơn hàng bị chặn</p>
          </div>
        </article>
      </div>
      <div class="row">
