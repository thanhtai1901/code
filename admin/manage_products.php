  ...
  if ($do == "edit") {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if (isset($product_name)) {
        if ($product_name == "") {
          $product_nameError = "Hãy nhập Tên Sản phẩm";
          $check = 0;
        }
      }
      if (isset($product_description)) {
        if ($product_description == "") {
          $check = 0;
          $product_descriptionError = "Hãy nhập mô tả";
        }
      }
      if (isset($product_price)) {
        if ($product_price == "") {
          $check = 0;
          $product_priceError = "Hãy nhập giá";
        }
      }
      if (isset($product_quantity)) {
        if ($product_quantity == "") {
          $check = 0;
          $product_quantityError = "Hãy nhập số lượng";
        }
      }
      if (isset($product_tag)) {
        if ($product_tag == "") {
          $check = 0;
          $product_tagError = "Thẻ sản phẩm không được để trống!";
        }
      }
      if ($check == 1) {
  ...
  // Add
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if (isset($product_price)) {
        if ($product_price == "") {
          $check = 0;
          $product_priceError = "Hãy nhập giá tiền";
        }
      }
      if (isset($product_quantity)) {
        if ($product_quantity == "") {
            ...
            <div class="form-body">
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="form-group has-icon-left">
                    <div class="position-relative row justify-content-center align-items-center d-flex">
                      <input type="text" name="product_name" value="<?php if ($do == 'edit') {
                                                                      echo $row["product_name"];
                                                                    } ?>" class="form-control col-9 mb-2" style="border: 1px solid #dce7f1 !important;" id="first-name-icon">
                ...
                <div class="col-md-8">
                  <div class="form-group has-icon-left">
                    <div class="position-relative row justify-content-center align-items-center d-flex">
                      <input type="text" name="product_description" value="<?php if ($do == 'edit') {
                ...
                <div class="col-md-8">
                  <div class="form-group has-icon-left">
                    <div class="position-relative row justify-content-center align-items-center d-flex">
                      <input type="number" name="product_price" value="<?php if ($do == 'edit') {
                ...
                <div class="col-md-8">
                  <div class="form-group has-icon-left">
                    <div class="position-relative row justify-content-center align-items-center d-flex">
                      <input type="number" name="product_quantity" value="<?php if ($do == 'edit') {
                ...
                <div class="col-md-8">
                  <div class="form-group has-icon-left">
                    <div class="position-relative row justify-content-center align-items-center d-flex">
                      <input type="text" name="product_tag" value="<?php if ($do == 'edit') {
                                                                      echo $row["product_tag"];
                                                                    } ?>" placeholder="Tách thẻ bằng dấu phẩy (,)" class="form-control col-9 mb-2" style="border: 1px solid #dce7f1 !important;" id="first-name-icon">
                      <div class="form-text" style='color:red;'>
                ...
                <div class="col-md-8">
                  <div class="form-group has-icon-left">
                    <div class="position-relative row justify-content-center align-items-center d-flex">
                      <input type="text" name="product_size" value="<?php if ($do == 'edit') {
                                                                      echo $row["product_size"];
                                                                    } ?>" placeholder="Tách kích thước bằng dấu phẩy (,)" class="form-control col-9 mb-2" style="border: 1px solid #dce7f1 !important;" id="first-name-icon">
        ...
        <div class="col-lg-12">
          <div class="users-table table-wrapper">
            <table class="table table-striped" id="table1">
              <a href="manage_products.php?do=add" class="btn btn-success" style="float: right;margin:10px 50px 0px 10px;">Thêm sản phẩm</a>
              <thead>
              ...
              <tbody>
                <?php foreach ($product as $key => $row) { ?>
                  <tr>
                      ...
                      <label class="users-table__checkbox">
                        <div class="categories-table-img">
                          <picture>
                            ...
                            <img src="<?php echo isset($row['product_main_image']) ? $row['product_main_image'] : ''; ?>" alt="Hình ảnh">
                          </picture>
                        </div>
                      </label>
                    </td>
                    ...
                    <td><span class="badge-pending"><?php echo isset($row['product_price']) ? number_format($row['product_price'] * 2300, 0, ',', '.') . ' VNĐ' : ''; ?></span></td>
