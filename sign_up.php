    ...
    <!-- <div class="wrapper" style="background-image: url('images/bg-registration-form-1.jpg');"> -->
        <div class="inner">
            ...
            <form id="signup_form" method="POST" enctype="multipart/form-data">
                ...
                <button id="signUp_insignup_btn" type="submit" name="btn">Đăng kí
                    <i class="zmdi zmdi-arrow-right"></i>
                </button>
                <div class="dont">
                    <span class="dont">Bạn đã có tài khoản? <a class="ms-1 regster-href" href="sign_in.php">Đăng nhập</a></span>
                </div>
            </form>
        </div>
    </div>
